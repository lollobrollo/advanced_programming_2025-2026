...
def main():
    processed_data = process_data(
        data, data_config['column1'], data_config['column2'], data_config['result_column'])
    ...
    additional_data = additional_operation(
        processed_data, data_config['column1'], data_config['column2'],
